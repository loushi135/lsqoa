...
//	}
	...
	public static void main(String[] args) {
		try {
			Service service = new Service();
			Call call = (Call) service.createCall();
			call.setTargetEndpointAddress(new java.net.URL("http://localhost:8080/ljtoa/services/LoginServiceImpl"));
...
//			call.setOperationName("Login");
			...
			call.setOperationName("getInfoCount");
			String translateText = (String) call.invoke(new Object[] { "admin","1"});
			
			/*
			 * invoke方法的参数是Object数组,该数组元素个数与方法参数一致
//			 */
//			String translateText = (String) call.invoke(new Object[] { "1","1","部门负责人审批","70"});
//			String translateText = (String) call

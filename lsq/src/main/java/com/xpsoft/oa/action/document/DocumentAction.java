 ...
 public class DocumentAction extends BaseAction
 {
   ...
   public String shareList()
   {
     ...
     List<Document> list = this.documentService.findByIsShared(this.document, this.from, this.to, appUser.getUserId(), arrayList, depId, pb);
   ...
   public String publicList()
   {
     ...
     List<Document> list = this.documentService.findByPublic(path, this.document, this.from, this.to, ContextUtil.getCurrentUser(), pb);
   ...
   public String displayPublic(){
	   PagingBean pb = getInitPagingBean();
	     ...
	     List<Document> list = this.documentService.findByPublic(path, this.document, this.from, this.to, ContextUtil.getCurrentUser(), pb);
	     getRequest().setAttribute("publicDocumentList", list);

 ...
 *
 */
public class SignApplyAction extends BaseAction{
	@Resource
	...
	public String list(){
		...
		List<SignApply> list= signApplyService.getAll(filter);
		
		Type type=new TypeToken<List<SignApply>>(){}.getType();
	...
	public String multiDel(){
		...
		if(ids!=null){
			for(String id:ids){
				signApplyService.remove(new Long(id));
			}
		}
	...
	public String get(){
		...
		sb.append(gson.toJson(signApply));
		sb.append("}");

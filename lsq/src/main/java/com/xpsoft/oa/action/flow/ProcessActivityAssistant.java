 ...
 public class ProcessActivityAssistant
 {
   ...
   public static Map<String, ParamField> constructFieldMap(String processName, String activityName)
   {
     ...
     for (Element el : els) {
       ...
       Short isShowed = Short.valueOf((attIsShowed == null) || ("true".equals(attIsShowed.getValue())) ? (short)1 : (short)0);
   ...
   public static String getFormAbsPath(String processName,String activityName){
		return AppUtil.getFlowFormAbsolutePath() +  processName+"/" + activityName+ ".vm";
	}
   public static String getJspFormAbsPath(String processName,String activityName){
		return AppUtil.getFlowFormAbsolutePath() +  processName+"/" + activityName+ ".jsp";
	}

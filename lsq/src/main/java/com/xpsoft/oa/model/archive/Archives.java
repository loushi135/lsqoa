...
public class Archives extends BaseModel {
	public static final Short STATUS_DRAFT = Short.valueOf((short) 0);

	public static final Short STATUS_ISSUE = Short.valueOf((short) 1);

	public static final Short STATUS_ARCHIVE = Short.valueOf((short) 2);

	public static final Short STATUS_HANDLE = Short.valueOf((short) 1);

	public static final Short STATUS_HANDLEING = Short.valueOf((short) 2);

	public static final Short STATUS_LEADERREAD = Short.valueOf((short) 3);

	public static final Short STATUS_DISPATCH = Short.valueOf((short) 4);

	public static final Short STATUS_READ = Short.valueOf((short) 5);

	public static final Short STATUS_READING = Short.valueOf((short) 6);

	public static final Short STATUS_END = Short.valueOf((short) 7);

	public static final Short ARCHIVE_TYPE_DISPATCH = Short.valueOf((short) 0);

	public static final Short ARCHIVE_TYPE_RECEIVE = Short.valueOf((short) 1);
	...
	public Long getTypeId() {
		return getArchivesType() == null ? null : getArchivesType()
				.getTypeId();
	}
	...
	public Long getRecTypeId() {
		return getArchRecType() == null ? null : getArchRecType()
				.getRecTypeId();
	}

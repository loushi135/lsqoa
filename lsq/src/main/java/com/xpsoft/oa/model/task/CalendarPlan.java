 ...
 {
   public static final Short STATUS_UNFINISHED = Short.valueOf((short) 0);
 
   public static final Short STATUS_FINISHED = Short.valueOf((short) 1);
 
   public static final Short URGENT_COMMON = Short.valueOf((short) 0);
 
   public static final Short URGENT_IMPORTANT = Short.valueOf((short) 1);
 
   public static final Short URGENT_INST = Short.valueOf((short) 2);
...
//   protected String userId;
   @Expose
	protected java.util.Set userPlan = new java.util.HashSet();
...
// 
   ...
   public java.util.Set getUserPlan() {
	return userPlan;
}

public void setUserPlan(java.util.Set userPlan) {

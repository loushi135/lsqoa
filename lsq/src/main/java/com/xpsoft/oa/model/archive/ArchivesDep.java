...
public class ArchivesDep extends BaseModel {
	public static final Short RECEIVE_MAIN = Short.valueOf((short) 1);

	public static final Short RECEIVE_COPY = Short.valueOf((short) 0);

	public static final Short STATUS_SIGNED = Short.valueOf((short) 1);

	public static final Short STATUS_UNSIGNED = Short
			.valueOf((short) 0);

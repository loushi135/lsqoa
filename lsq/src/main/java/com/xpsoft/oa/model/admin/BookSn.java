 ...
 */
public class BookSn extends com.xpsoft.core.model.BaseModel {

    protected Long bookSnId;
	protected String bookSN;
	protected Short status;
	protected com.xpsoft.oa.model.admin.Book book;
	...
	public com.xpsoft.oa.model.admin.Book getBook () {
		return book;
	}	
	
	public void setBook (com.xpsoft.oa.model.admin.Book in_book) {
		this.book = in_book;
	}
	...
	public void setBookId(Long aValue) {
	    if (aValue==null) {
	        ...
	        book = new com.xpsoft.oa.model.admin.Book(aValue);

...
public class LeaderRead extends BaseModel {
	public static Short NOT_CHECK = Short.valueOf((short) 0);
	public static Short IS_PASS = Short.valueOf((short) 1);
	public static Short NOT_PASS = Short.valueOf((short) 2);

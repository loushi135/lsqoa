 ...
 */
public class BookBorRet extends com.xpsoft.core.model.BaseModel {
    ...
    protected Integer boorowAmount;
    protected Long registerId;
    protected Long userId;
    protected Long processRunId;

	protected com.xpsoft.oa.model.admin.BookSn bookSn;
	...
	public Integer getBoorowAmount() {
		return boorowAmount;
	}

	public void setBoorowAmount(Integer boorowAmount) {
		this.boorowAmount = boorowAmount;
	}
	...
	public com.xpsoft.oa.model.admin.BookSn getBookSn () {
		return bookSn;
	}	
	
	public void setBookSn (com.xpsoft.oa.model.admin.BookSn in_bookSn) {
	...
	public void setBookSnId(Long aValue) {
	    if (aValue==null) {
	        ...
	        bookSn = new com.xpsoft.oa.model.admin.BookSn(aValue);

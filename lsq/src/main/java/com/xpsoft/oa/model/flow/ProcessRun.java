...
public class ProcessRun extends BaseModel {
	public static final Short RUN_STATUS_INIT = Short
			.valueOf((short) 0);

	public static final Short RUN_STATUS_RUNNING = Short
			.valueOf((short) 1);

	public static final Short RUN_STATUS_FINISHED = Short
			.valueOf((short) 2);
	public static final Short RUN_STATUS_UNPASSED = Short
	.valueOf((short) 3);

...
public class TaskSign extends com.xpsoft.core.model.BaseModel {
	...
	protected com.xpsoft.oa.model.flow.ProUserAssign proUserAssign;
	...
	public com.xpsoft.oa.model.flow.ProUserAssign getProUserAssign() {
		return proUserAssign;
	}

	public void setProUserAssign(
			com.xpsoft.oa.model.flow.ProUserAssign in_proUserAssign) {
	...
	public void setAssignId(Long aValue) {
		if (aValue == null) {
			...
			proUserAssign = new com.xpsoft.oa.model.flow.ProUserAssign(aValue);
	...
	/**
	 * 1=pass 通过 0=reject 拒绝 * @return Short
	 * 

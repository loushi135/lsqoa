...
import com.xpsoft.oa.model.system.UserAgent;
...
public class UserAgentUtil {
	...
	public static UserAgent getUserAgent(String userAgent) {
		...
		if (userAgent.contains("Windows")) {// 主流应用靠前
			...
			if (userAgent.contains("iPod")) {
				return judgeBrowser(userAgent, "Phone", null, null);// 判断浏览器
			}else if (userAgent.contains("iPad")) {
				return judgeBrowser(userAgent, "Pad", null, null);// 判断浏览器
			}else if (userAgent.contains("iPhone")) {
				return judgeBrowser(userAgent, "Phone", null, null);// 判断浏览器
			}else{
				return judgeBrowser(userAgent, "Mac OS", null, null);// 判断浏览器
			}
		}else if(userAgent.contains("Linux i686")){
			return judgeBrowser(userAgent, "Linux", null, null);// 判断浏览器
		}else if(userAgent.contains("Android 3.0")||userAgent.contains("Android 3.1")||userAgent.contains("Android 3.2")){
			return judgeBrowser(userAgent, "Pad", null, null);// 判断浏览器
	...
	private static UserAgent judgeBrowser(String userAgent,
		...
		if (userAgent.contains("Chrome")) {
			...
			return new UserAgent("Safari", null, platformType,
					platformSeries, platformVersion);
		}else if (userAgent.contains("Maxthon")) {
			return new UserAgent("Maxthon", null, platformType,
					platformSeries, platformVersion);
		}else if (userAgent.contains("QQBrowser")) {
			return new UserAgent("QQBrowser", null, platformType,
					platformSeries, platformVersion);
		}else if (userAgent.contains("GreenBrowser")) {
			return new UserAgent("GreenBrowser", null, platformType,
					platformSeries, platformVersion);
		}else if (userAgent.contains("360SE")) {
			return new UserAgent("360SE", null, platformType,
					platformSeries, platformVersion);
		}else if (userAgent.contains("Opera")) {
			return new UserAgent("Opera", null, platformType,
					platformSeries, platformVersion);

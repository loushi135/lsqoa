...
import org.dom4j.io.XMLWriter;
 ...
 public class XmlUtil
 {
   ...
   public static String reponseXml(String bodyXml){
	   StringBuffer sb = new StringBuffer();
	    //消息头
	   StringBuffer header = new StringBuffer();
	   header.append("<header>\n");
//	   header.append("		<messengerId >0000</messengerId>");
	   header.append("  <timeStamp>"+new Date().getTime()+"</timeStamp>\n");	
//	   header.append("		<digest>"+digestStr+"</digest>");
	   header.append("</header>\n");
	   //拼装消息

...
<div data-role="content">
	...
	<div data-role="fieldcontain" id="sumPrice_field">
		...
		<input id="sumPriceId" name="constructionContract.sumPrice" data-theme="b" type="text"
			class="required money"  value="${constructionContract_sumPrice}" />
	</div>
	<div data-role="fieldcontain" id="sumPriceBig_field">
		<font color="red"><label id="sumPriceLabelId">
				(${constructionContract_sumPriceBig})
			</label>
		</font>
		<input id="sumPriceBigId" name="constructionContract.sumPriceBig" type="hidden"
	...
	<div data-role="fieldcontain" id="payWay_field">
		<fieldset data-role="controlgroup" style="padding-right: 0px;">
			...
			<textarea name="constructionContract.payWay" id="payWayId" placeholder="付款方式"
					style="width: 100%;" class="required">${constructionContract_payWay}</textarea>
		</fieldset>

...
<script>
	...
	function moneyToUCase(money){
		...
		$("#ticketApplyPanel span").html(result);
	}
...
<div data-role="content">
     ...
     <div id="hiddenDiv">
     	<div data-role="fieldcontain" id="ticketApplyPanel">
		       <label for="txtBirthday">总费用(元)：</label></br>
		       <input type="text" name="ticketApply.amount" class="required money" onkeyup="moneyToUCase(this.value);"/></br>
		       <span style="color: red;"></span>
		       <input type="hidden" id="amountBig"  name="ticketApply.amountBig" class="required"/>
		 </div>
     </div>
 </div>

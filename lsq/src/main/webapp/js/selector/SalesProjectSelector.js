	...
	getView : function(h, f) {
		...
		var c = new Ext.data.Store({
					proxy : new Ext.data.HttpProxy({
								url : __ctxPath
										+ "/statistics/listSalesProject.do"
							}),
		...
		var a = new Ext.FormPanel({
					...
					items : [{
								...
								iconCls : "search",
								handler : function() {
									var i = Ext.getCmp("SalesProjectSelectorForm");
									var j = Ext.getCmp("SalesProjectSelectorGrid");
		...
		var e = new Ext.Window({
			...
			buttons : [{
				...
				text : "确定",
				handler : function() {
					var n = Ext.getCmp("SalesProjectSelectorGrid");

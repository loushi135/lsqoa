	...
	getView : function(h, f) {
		...
		var c = new Ext.data.Store({
					proxy : new Ext.data.HttpProxy({
								url : __ctxPath
										+ "/statistics/listDesignProject.do"
							}),
		...
		var a = new Ext.FormPanel({
					...
					items : [{
								...
								iconCls : "search",
								handler : function() {
									var i = Ext.getCmp("DesignProjectSelectorForm");
									var j = Ext.getCmp("DesignProjectSelectorGrid");
		...
		var e = new Ext.Window({
			...
			buttons : [{
				...
				text : "确定",
				handler : function() {
					var n = Ext.getCmp("DesignProjectSelectorGrid");

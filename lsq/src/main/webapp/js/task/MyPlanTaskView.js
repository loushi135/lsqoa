                        ...
                        if (prueba.viewscheduler.listbody.periodType == 1) {
                            ...
                            if (prueba.viewscheduler.listbody.periodType == 2) {
                                ...
                                if (prueba.viewscheduler.listbody.periodType == 3) {
                                    var a = prueba.viewscheduler.getDatesforBimonth(prueba.currentdate);
                                    calendarStore.baseParams = {
                                        action: "period",
...
function my_calendar() {
    ...
    prueba = new Ext.ECalendar({
        ...
        tplTaskZoom: new Ext.XTemplate('<tpl for=".">', '<div class="ecal-show-basetasktpl-div"><b>主题:</b>{subject}<br>', "<b>开始1:</b>{startdate}<br><b>结束1:</b>{enddate}", "<br><b>明细:</b><hr>{description}</div>", "</tpl>"),
        ...
        iconSchedView: __ctxPath + "/ext3/ux/caltask/images/calendar_view_schedule.png",
    ...
    prueba.on({
        ...
        "onTaskDelete": {
            fn: function(j) {
                var k = confirm("Delete event " + j[1] + " " + j[2] + "...? YES/NO");
                return k;
            },
            scope: this
        },
        "afterTaskDelete": {
            fn: function(j, k) {
                k ? alert("Event: " + j[1] + " " + j[2] + " Deleted") : alert("Event Delete was canceled..!");
                updateStoreincalendar();
            },
            scope: this
        },
                ...
                if (k == "month") {} else {
                    if (k == "day") {
                        ...
                        if (k == "week") {} else {
                            if (k == "scheduler") {
                                task = j;
                                n = "Task id:" + task[0] + ":" + task[2] + "<br>";
                                n += "starts:" + task[3] + "<br>";
                                n += "Ends:" + task[4] + "<br>";
                                n += "contents:" + task[5] + "<br>";
                                n += "index:" + task[6] + "<br>";
                                n += "Test Menu:" + m + "<br>";
                                Ext.Msg.alert("(Scheduler) Task information" + k, n);
                            }
                        }
                    }
                }

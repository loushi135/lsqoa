	...
	initUIComponents : function() {
		this.searchPanel = new Ext.FormPanel({
			...
			items : [{
						...
						iconCls : "search",
						handler : function() {
							var c = Ext.getCmp("OfficeGoodsSearchForm");
							var d = Ext.getCmp("OfficeGoodsGrid");
		...
		this.store = new Ext.data.Store({
					...
					reader : new Ext.data.JsonReader({
								...
								fields : [
										...
										"specifications", "unit", "isWarning",
										"warnCounts", "notes", "stockCounts","price"]
							}),
					remoteSort : true
				});
...
//					}, 
						...
						renderer : function(f, e, c, i, d) {
							...
							if (isGranted("_OfficeGoodsDel")) {
								g = '<button title="删除" value=" " class="btn-del" onclick="OfficeGoodsView.remove('
										+ h + ')">&nbsp;</button>';
							}
							if (isGranted("_OfficeGoodsEdit")) {
								g += '&nbsp;<button title="编辑" value=" " class="btn-edit" onclick="OfficeGoodsView.edit('
										+ h + ')">&nbsp;</button>';
							}
							return g;
						}

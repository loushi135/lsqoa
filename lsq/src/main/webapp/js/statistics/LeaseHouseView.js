/**
 * @author:
 * @class LeaseHouseView
 * @extends Ext.Panel
 * @description [LeaseHouse]管理
 * @company
 * @createtime:2010-07-19
 */
LeaseHouseView = Ext.extend(Ext.Panel, {
	// 条件搜索Panel
	searchPanel : null,
	// 数据展示Panel
	gridPanel : null,
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		LeaseHouseView.superclass.constructor.call(this, {
					id : 'LeaseHouseView',
					title : '租房信息统计',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.store = new Ext.data.JsonStore({
					url : __ctxPath + "/statistics/listLeaseHouse.do",
					root : 'result',
					...
					fields : [{
								name : 'id',
								type : 'int'
							}, 'reporter', 'reporterDepatment',
							'reporterCompanyName', 'project', 'leaseStart',
							'leaseEnd', 'monthlyRent','yearRent', 'cause','processRunId','attachFiles']
				});
		...
		this.topbar = new Ext.Toolbar({
					...
					items : [{
								...
								text : '添加租房信息',
								xtype : 'button',
								hidden:!isGranted("_LeaseHouseAdd"),
								handler:this.createRecord
					       },{
								iconCls : 'btn-del',
								text : '删除租房信息',
								xtype : 'button',
							    hidden:!isGranted("_LeaseHouseDel"),
						...
						Ext.Ajax.request({
									...
									success : function(response, options) {
										Ext.ux.Toast.msg('操作信息',
												'成功删除该租房信息！');
										Ext.getCmp('LeaseHouseGrid').getStore()
												.reload();
									},

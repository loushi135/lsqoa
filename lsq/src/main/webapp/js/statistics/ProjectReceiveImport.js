 ...
 */
ProjectReceiveImport=Ext.extend(Ext.Window,{
	//内嵌FormPanel
	formPanel:null,
	//构造函数
	constructor:function(_cfg){
		...
		ProjectReceiveImport.superclass.constructor.call(this,{
			id:'ProjectReceiveImportWin',
			layout:'fit',
	...
	initUIComponents:function(){
		this.formPanel=new Ext.FormPanel({
				...
				border:false,
				url : __ctxPath + '/statistics/importsProjectReceive.do',
				id : 'ProjectReceiveImport',
				defaults : {
					anchor : '98%,98%'
				},
...
//								
					...
					items : [{
								...
								xtype : 'hidden',
								name : 'attachIds',
								id : 'project_suppliersAssess.attachIds'
							}, {
								xtype : 'hidden',
								//name : 'suppliersAssess.attachFiles',
								id : 'project_suppliersAssess.attachFiles'
							}, {
								xtype : 'panel',
								id : 'project_suppliersAssess.displayAttach',
								columnWidth : .95,
								height : 65,
								frame : false,
								autoScroll : true,
								...
								handler : function() {
									var dialog = App.createUploadDialog({
										file_cat : 'flow/projectReceive',
										permitted_extensions:['xls'],
										callback : function(data) {
											var attachFiles = Ext.getCmp("project_suppliersAssess.attachFiles");
											var fileIds = Ext.getCmp('project_suppliersAssess.attachIds');
											var display = Ext.getCmp('project_suppliersAssess.displayAttach');
											display.body.update('');
		...
		if (formPanel.getForm().isValid()) {
			formPanel.getForm().submit({
				...
				success : function(fp, action) {
					...
					var projectReceiveView=Ext.getCmp('ProjectReceiveView');
					if(!Ext.isEmpty(projectReceiveView)){

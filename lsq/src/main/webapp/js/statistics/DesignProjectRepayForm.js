 ...
 * @author
 * @createtime
 * @class DesignProjectRepayForm
 * @extends Ext.Window
 * @description ProjectRepay表单
 */
DesignProjectRepayForm = Ext.extend(Ext.Window, {
	// 内嵌FormPanel
	formPanel : null,
	// 构造函数
	constructor : function(_cfg) {
		...
		DesignProjectRepayForm.superclass.constructor.call(this, {
					id : 'DesignProjectRepayFormWin',
					layout : 'fit',
	...
	initUIComponents : function() {
		this.formPanel = new Ext.FormPanel({
			...
			items : [{
						...
						name : 'projectRepay.designProject.id',
						id : 'projectRepay.designProject.id',
						xtype : 'hidden'
					}, {
						...
						fieldLabel : '项目名称',
						allowBlank : false,
						name : 'projectRepay.designProject.proName',
						id : 'projectRepay.designProject.proName',
						xtype : 'textfield',
						listeners : {
							'focus' : function() {
								DesignProjectSelector.getView(
										function(proId, proName) {
											Ext.getCmp("projectRepay.designProject.id").setValue(proId);
											Ext.getCmp("proId").setValue(proId);
											Ext.getCmp("projectRepay.designProject.proName").setValue(proName);
										}, true, true).show();
							}
						}
					}, {
		...
		if (this.id != null && this.id != 'undefined') {
			this.formPanel.getForm().load({
				...
				success : function(form, action) {
					...
					Ext.getCmp("projectRepay.designProject.id").setValue(record.data.designProject.id);
					Ext.getCmp("projectRepay.designProject.id").originalValue = record.data.designProject.id;
					
					Ext.getCmp("projectRepay.designProject.proName").setValue(record.data.designProject.proName);
					Ext.getCmp("projectRepay.designProject.proName").originalValue = record.data.designProject.proName;
		...
		if (formPanel.getForm().isValid()) {
			formPanel.getForm().submit({
						...
						success : function(fp, action) {
							...
							var projectRepayView = Ext.getCmp('DesignProjectRepayView');

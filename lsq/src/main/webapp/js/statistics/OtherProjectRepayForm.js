 ...
 * @author
 * @createtime
 * @class OtherProjectRepayForm
 * @extends Ext.Window
 * @description ProjectRepay表单
 */
OtherProjectRepayForm = Ext.extend(Ext.Window, {
	// 内嵌FormPanel
	formPanel : null,
	// 构造函数
	constructor : function(_cfg) {
		...
		OtherProjectRepayForm.superclass.constructor.call(this, {
					id : 'OtherProjectRepayFormWin',
					layout : 'fit',
	...
	initUIComponents : function() {
		this.formPanel = new Ext.FormPanel({
			...
			items : [{
						...
						name : 'projectRepay.otherProject.id',
						id : 'projectRepay.otherProject.id',
						xtype : 'hidden'
					}, {
						...
						fieldLabel : '项目名称',
						allowBlank : false,
						name : 'projectRepay.otherProject.proName',
						id : 'projectRepay.otherProject.proName',
						xtype : 'textfield',
						listeners : {
							'focus' : function() {
								OtherProjectSelector.getView(
										function(proId, proName) {
											Ext.getCmp("projectRepay.otherProject.id").setValue(proId);
											Ext.getCmp("proId").setValue(proId);
											Ext.getCmp("projectRepay.otherProject.proName").setValue(proName);
										}, true, true).show();
							}
						}
					}, {
		...
		if (this.id != null && this.id != 'undefined') {
			this.formPanel.getForm().load({
				...
				success : function(form, action) {
					...
					Ext.getCmp("projectRepay.otherProject.id").setValue(record.data.otherProject.id);
					Ext.getCmp("projectRepay.otherProject.id").originalValue = record.data.otherProject.id;
					
					Ext.getCmp("projectRepay.otherProject.proName").setValue(record.data.otherProject.proName);
					Ext.getCmp("projectRepay.otherProject.proName").originalValue = record.data.otherProject.proName;
		...
		if (formPanel.getForm().isValid()) {
			formPanel.getForm().submit({
						...
						success : function(fp, action) {
							...
							var projectRepayView = Ext.getCmp('OtherProjectRepayView');

/**
 * @author:
 * @class ProjectRepayView
 * @extends Ext.Panel
 * @description [ProjectRepay]管理
 * @company
 * @createtime:2010-07-19
 */
ProjectRepayView = Ext.extend(Ext.Panel, {
	// 条件搜索Panel
	searchPanel : null,
	mainPanel : null,
	// 数据展示Panel
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		ProjectRepayView.superclass.constructor.call(this, {
					id : 'ProjectRepayView',
					title : '[工程项目报销]管理',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.rowActions = new Ext.ux.grid.RowActions({
					...
					actions : [{
								...
								hide : !isGranted("_ProjectRepayDel")
							}, {
								iconCls : 'btn-edit',
								qtip : '编辑',
								style : 'margin:0 3px 0 3px',
								hide : !isGranted("_ProjectRepayEdit")
							}]
				});
		...
		this.topbar = new Ext.Toolbar({
					...
					items : [{
								...
								scope : this,
								hidden : !isGranted("_ProjectRepayAdd")
							}, {
								iconCls : 'btn-del',
								text : '删除[报销]',
								xtype : 'button',
								...
								scope : this,
								hidden : !isGranted("_ProjectRepayDel")
							}]
				});
		...
		this.gridPanel.addListener('rowdblclick', function(grid, rowindex, e) {
					grid.getSelectionModel().each(function(rec) {
								if (isGranted("_ProjectRepayEdit")) {
									new ProjectRepayForm({
												id : rec.data.id
											}).show();
								}
							});
	 ...
	 */
	delRecords : function() {
		var gridPanel = Ext.getCmp('ProjectRepayGrid');

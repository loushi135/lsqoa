 ...
 */
ProjectRepayForm = Ext.extend(Ext.Window, {
	// 内嵌FormPanel
	formPanel : null,
	// 构造函数
	constructor : function(_cfg) {
		...
		ProjectRepayForm.superclass.constructor.call(this, {
					id : 'ProjectRepayFormWin',
					layout : 'fit',
	...
	initUIComponents : function() {
		this.formPanel = new Ext.FormPanel({
			...
			items : [{
						...
						name : 'projectRepay.project.id',
						id : 'projectRepay.project.id',
						xtype : 'hidden'
					}, {
						...
						fieldLabel : '项目名称',
						allowBlank : false,
						name : 'projectRepay.project.proName',
						id : 'projectRepay.project.proName',
						xtype : 'textfield',
						listeners : {
							'focus' : function() {
								ProjectNewSelector.getView(
										function(proId, proName) {
											Ext.getCmp("projectRepay.project.id").setValue(proId);
											Ext.getCmp("proId").setValue(proId);
											Ext.getCmp("projectRepay.project.proName").setValue(proName);
										}, true, true).show();
							}
						}
					}, {
		...
		if (this.id != null && this.id != 'undefined') {
			this.formPanel.getForm().load({
				...
				success : function(form, action) {
					...
					Ext.getCmp("projectRepay.project.id")
							.setValue(record.data.project.id);
					Ext.getCmp("projectRepay.project.id").originalValue = record.data.project.id;
					
					Ext.getCmp("projectRepay.project.proName")
							.setValue(record.data.project.proName);
					Ext.getCmp("projectRepay.project.proName").originalValue = record.data.project.proName;
		...
		if (formPanel.getForm().isValid()) {
			formPanel.getForm().submit({
						...
						success : function(fp, action) {
							...
							var projectRepayView = Ext
									.getCmp('ProjectRepayView');

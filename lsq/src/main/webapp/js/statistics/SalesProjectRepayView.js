/**
 * @author:
 * @class SalesProjectRepayView
 * @extends Ext.Panel
 * @description [ProjectRepay]管理
 * @company
 * @createtime:2010-07-19
 */
SalesProjectRepayView = Ext.extend(Ext.Panel, {
	// 条件搜索Panel
	searchPanel : null,
	mainPanel : null,
	// 数据展示Panel
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		SalesProjectRepayView.superclass.constructor.call(this, {
					id : 'SalesProjectRepayView',
					title : '[营销项目报销]管理',
					region : 'center',
					layout : 'border',
	...
	initUIComponents : function() {
		...
		this.searchPanel = new Ext.FormPanel({
					...
					items : [{
								...
								name : 'Q_salesProject.proName_S_LK',
								xtype : 'textfield'
							}, {
								style : 'margin-top:5px;',
								xtype : 'label',
		...
		this.store = new Ext.data.JsonStore({
					...
					fields : [{
								name : 'id',
								type : 'int'
							}, 'amountBig', 'amount', 'proName','salesProject','proId', 'createtime',
		...
		this.rowActions = new Ext.ux.grid.RowActions({
					...
					actions : [{
								...
								hide : !isGranted("_SalesProjectRepayDel")
							}, {
								iconCls : 'btn-edit',
								qtip : '编辑',
								style : 'margin:0 3px 0 3px',
								hide : !isGranted("_SalesProjectRepayEdit")
							}]
				});
		...
		this.topbar = new Ext.Toolbar({
					...
					items : [{
								...
								scope : this,
								hidden : !isGranted("_SalesProjectRepayAdd")
							}, {
								iconCls : 'btn-del',
								text : '删除[报销]',
								xtype : 'button',
								...
								scope : this,
								hidden : !isGranted("_SalesProjectRepayDel")
							}, {
								iconCls : 'btn-xls',
								...
								xtype : 'button',
								hidden : !isGranted("_SalesProjectRepayImport"),
		...
		this.gridPanel.addListener('rowdblclick', function(grid, rowindex, e) {
					grid.getSelectionModel().each(function(rec) {
								if (isGranted("_SalesProjectRepayEdit")) {
									new SalesProjectRepayForm({
											id : rec.data.id
										}).show();											
								}
							});
	...
	createRecord : function() {
		new SalesProjectRepayForm().show();
	},
	/**
	 * 按IDS删除记录
	 * 
					...
					if (btn == 'yes') {
						Ext.Ajax.request({
									...
									success : function(response, options) {
										...
										obj.initData();
										Ext.getCmp('SalesProjectRepayGrid')
												.getStore().reload();
									},
	 ...
	 */
	delRecords : function() {
		var gridPanel = Ext.getCmp('SalesProjectRepayGrid');

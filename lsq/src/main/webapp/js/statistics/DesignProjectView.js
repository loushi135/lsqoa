/**
 * @author:
 * @class DesignProjectView
 * @extends Ext.Panel
 * @description [DesignProject]管理
 * @company
 * @createtime:2010-07-19
 */
DesignProjectView = Ext.extend(Ext.Panel, {
	// 条件搜索Panel
	searchPanel : null,
	// 数据展示Panel
	gridPanel : null,
	...
	constructor : function(_cfg) {
		...
		// 调用父类构造
		DesignProjectView.superclass.constructor.call(this, {
					id : 'DesignProjectView',
					title : '[设计项目]管理',
					region : 'center',
					layout : 'border',
					...
					columns : [sm, new Ext.grid.RowNumberer(), {
								...
								renderer:function(value,meta,record){
									if(!Ext.isEmpty(value)){
										var str = "";
										Ext.each(value,function(dept,i){
											if(str!=""){
												str+=",";
											}
												str+=dept.depName;

					...
					items : [{
								...
								handler : function() {
									...
									if(!Ext.isEmpty(data)){
										...
										Ext.getCmp('DocumentSharedForm.sharedUserIds').setValue(userId);
										Ext.getCmp('DocumentSharedForm.sharedUserNames').setValue(fullname);
									}
								}
							}]
				}, {
					...
					items : [{
								...
								handler : function() {
									...
									if(!Ext.isEmpty(data)){
										...
										Ext.getCmp('DocumentSharedForm.sharedDepIds').setValue(depId);
										Ext.getCmp('DocumentSharedForm.sharedDepNames').setValue(depName);
									}
								}
							}]
				}, {
					...
					items : [{
								...
								handler : function() {
									...
									if(!Ext.isEmpty(data)){
										...
										Ext.getCmp('DocumentSharedForm.sharedRoleIds').setValue(roleId);
										Ext.getCmp('DocumentSharedForm.sharedRoleNames').setValue(roleName);
									}
								}
							}]
				}]

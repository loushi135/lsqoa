 ...
 * @author
 * @createtime
 * @class UserFlowconfigForm
 * @extends Ext.Window
 * @description UserFlowconfig表单
 */
UserFlowconfigForm = Ext.extend(Ext.Window, {
			// 内嵌FormPanel
			formPanel : null,
			// 构造函数
			constructor : function(_cfg) {
				...
				UserFlowconfigForm.superclass.constructor.call(this, {
							id : 'UserFlowconfigFormWin',
							layout : 'fit',
			...
			initUIComponents : function() {
				this.formPanel = new Ext.FormPanel({
							...
							border : false,
							url : __ctxPath + '/system/updateUserFlowconfig.do',
							id : 'UserFlowconfigForm',
							defaults : {
								anchor : '98%,98%'
							},
							...
							items : [{
										...
										name : 'userFlowconfig.appUser.userId',
										id : 'userId',
										xtype : 'hidden'
									}, {
										fieldLabel : '姓名',
										name : 'userFlowconfig.appUser.username',
										id : 'username',
										xtype:'textfield',
										allowBlank : false,	
										listeners : {
											'focus' : function() {
												UserSelector.getView(function(n,l,mobile) {
																			Ext.getCmp("username").setValue(l);
																			Ext.getCmp("userId").setValue(n);
																		}, true)
																.show()
											}
										}

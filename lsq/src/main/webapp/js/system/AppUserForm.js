	...
	var a = new Ext.form.FormPanel(
			{
				...
				reader : new Ext.data.JsonReader( {
					...
					name : "appUser.staffNo",
					mapping : "staffNo"
				}, {
					name : "appUser.faxPhone",
					mapping : "faxPhone"
				}, {
					name : "appUserStatus",
					mapping : "status"
								...
								multiselects : [
										{
											...
											tbar : [{
												width : 250,
												id:'appUserSearchRole',
												xtype : 'textfield',
												emptyText : '筛选角色',
												enableKeyEvents:true,
												listeners : {
													'keyup' : function() {
														var store=Ext.getCmp("chooseRoles").store;
														var key=Ext.getCmp('appUserSearchRole').getValue();

 ...
 * http://www.iteye.com/topic/1123658 Ext LovCombo用在EditorGridPanel上时选择丢失问题的解决
 * http://blog.csdn.net/hahadekuai/article/details/7764047
 */
...
Ext.ux.form.LovCombo = Ext.extend(Ext.form.ComboBox, {
	...
	selectAll: function() {
		...
		this.setValue(this.getCheckedValue());
		this.doQuery(this.allQuery);
		this.fireEvent('select', this);//选择全部  触发 select事件
	},
